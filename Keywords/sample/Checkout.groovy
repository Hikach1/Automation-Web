...
public class Checkout {
	...
	def static void CheckoutShop(String firstName,String lastName,String companyName,String country,String address,String city,String postCode,String Phone){
		...
		Select2.selectOptionByLabel(findTestObject('latihan-katalon-page/select_single'), country)
		Select2.getAllOptionsLabel(findTestObject('latihan-katalon-page/select_single'))
		Select2.getSelectedOptionsLabel(findTestObject('latihan-katalon-page/select_single'))
